...
# sort icons in launchapd on mac alphabetically
...
info "Note that some of these changes require a logout/restart of your OS to take effect. At a minimum, be sure to restart your Terminal."
